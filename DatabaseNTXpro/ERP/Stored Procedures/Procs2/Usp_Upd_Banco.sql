...
BEGIN
	...
	UPDATE [PLE].[T3Banco] SET CodigoSunat = @CodigoSunat,
							   IdEntidad = @IdEntidad, FlagBorrador = @FlagBorrador,UsuarioModifico=@UsuarioModifico,FechaModificado =DATEADD(HOUR, 3, GETDATE()) WHERE ID = @IdBanco
