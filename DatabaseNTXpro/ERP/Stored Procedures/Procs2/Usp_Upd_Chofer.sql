CREATE PROC [ERP].[Usp_Upd_Chofer]
@IdChofer               INT,
@IdEntidad              INT out,
@IdTipoPersona          INT,
@IdTipoDocumento        INT,
...
BEGIN
        ...
        UPDATE ERP.Chofer SET  IdEntidad = @IdEntidad, FlagBorrador = @FlagBorrador ,FechaModificado = DATEADD(HOUR, 3, GETDATE()) ,
                UsuarioModifico=@UsuarioModifico, Licencia = UPPER(@Licencia) WHERE ID = @IdChofer
