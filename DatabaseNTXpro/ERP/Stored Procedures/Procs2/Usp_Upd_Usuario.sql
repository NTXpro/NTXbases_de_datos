CREATE PROC [ERP].[Usp_Upd_Usuario]
@IdUsuario				INT,
@IdEntidad				INT out,
@Correo					VARCHAR(100),
@Clave					VARCHAR(20),
...
BEGIN
	...
	IF @IdEntidad = 0
		...
		UPDATE Seguridad.Usuario SET Correo = @Correo , Clave = @Clave, IdEntidad = @IdEntidad,IdVersion = 1, UsuarioModifico = @UsuarioRegistro,FechaModificado = DATEADD(HOUR, 3, GETDATE()),FlagBorrador = @FlagBorrador, IdProyecto = @IdProyecto
		WHERE ID = @IdUsuario
