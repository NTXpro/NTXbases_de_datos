CREATE PROC [ERP].[Usp_Upd_Cliente]
@IdCliente				INT,
@IdEntidad				INT out,
@IdVendedor				INT,
@IdTipoPersona			INT,
...
BEGIN
	...
	UPDATE ERP.Cliente
	SET IdVendedor = @IdVendedor, IdEntidad = @IdEntidad, IdTipoRelacion = @IdTipoRelacion, Correo = @Correo, DiasVencimiento = @DiasVencimiento, 
	FlagBorrador = @FlagBorrador ,FechaModificado=DATEADD(HOUR, 3, GETDATE()) ,UsuarioModifico=@UsuarioModifico,
