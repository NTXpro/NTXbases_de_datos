...
CREATE PROC [ERP].[Usp_Ins_Transporte]
@IdTransporte			INT OUT,
@IdEntidad				INT OUT,
@IdEmpresa				INT,
@IdTipoPersona			INT,
@IdTipoDocumento		INT,
...
BEGIN
		...
		ELSE
			...
			INSERT INTO ERP.Transporte( 
										...
										UsuarioRegistro,
										FechaRegistro)
										VALUES(@IdEntidad,@IdEmpresa,@Flag,@FlagBorrador,@UsuarioRegistro,DATEADD(HOUR, 3, GETDATE()))

			SET @IdTransporte = (SELECT CAST(SCOPE_IDENTITY() AS INT));
END
