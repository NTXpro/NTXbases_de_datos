CREATE PROC [ERP].[Usp_Ins_Chofer]
@IdChofer               INT OUT,
@IdEntidad              INT OUT,
@IdEmpresa              INT,
@IdTipoPersona          INT,
...
BEGIN
        ...
        INSERT INTO ERP.Chofer(IdEntidad,IdEmpresa,Licencia,UsuarioRegistro,UsuarioModifico,FechaRegistro,FechaModificado,FlagBorrador,Flag)
        VALUES(@IdEntidad, @IdEmpresa,UPPER(@Licencia),@UsuarioRegistro,@UsuarioRegistro,DATEADD(HOUR, 3, GETDATE()),DATEADD(HOUR, 3, GETDATE()),@FlagBorrador, 1)

        SET @IdChofer = (SELECT CAST(SCOPE_IDENTITY() AS INT));
