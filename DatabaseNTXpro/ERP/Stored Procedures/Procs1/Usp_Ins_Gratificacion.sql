CREATE PROCEDURE [ERP].[Usp_Ins_Gratificacion]
@IdGratificacion	 INT OUTPUT,
...
BEGIN
		...
		FROM @XMLGratificacion.nodes('/ArchivoPlanoGratificacion')	AS T(N)
		SET @IdGratificacion = SCOPE_IDENTITY();
