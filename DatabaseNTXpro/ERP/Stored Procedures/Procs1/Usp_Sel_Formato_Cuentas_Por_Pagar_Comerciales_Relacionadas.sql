CREATE PROC [ERP].[Usp_Sel_Formato_Cuentas_Por_Pagar_Comerciales_Relacionadas]
@IdEmpresa int,
@IdAnio int,
@IdMes int 
...
AND PC.CuentaContable LIKE '43%'
AND P.IdAnio = @IdAnio
AND A.IdEmpresa = @IdEmpresa
AND P.IdMes= @IdMes
GROUP BY PC.CuentaContable,PC.Nombre, E.Nombre, T2.CodigoSunat, ETD.NumeroDocumento
END