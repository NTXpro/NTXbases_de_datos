...
CREATE PROC [ERP].[Usp_Ins_AsientoContable_Venta] 
@IdAsiento INT OUT,
@IdComprobante INT,
@IdOrigen INT,
@IdSistema INT
...
@IdPeriodo,
@NombreAsiento,
TC.CodigoSunat + '-' + C.SerieDocumentoComprobante,
@IdOrigen,
@OrdenAsiento,
Fecha,
IdMoneda,
...
ELSE
	CAST(2 AS INT)
END, --HABER
CASE WHEN @CountPlanCuenta = 1 AND C.IdMoneda = 1 THEN
...
END,
------------------------------------
CASE WHEN @CountPlanCuenta = 1 AND C.IdMoneda = 2 THEN
	CAST(C.SubTotal AS DECIMAL(14,2))
