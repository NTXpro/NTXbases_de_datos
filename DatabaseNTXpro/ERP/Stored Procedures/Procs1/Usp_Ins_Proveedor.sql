CREATE PROC [ERP].[Usp_Ins_Proveedor]
@IdProveedor			INT OUT,
@IdEntidad				INT OUT,
@IdEmpresa				INT,
@IdTipoPersona			INT,
...
BEGIN
		...
		INSERT INTO ERP.Proveedor(IdEntidad,IdEmpresa,UsuarioRegistro,FechaRegistro,FlagBorrador,Flag,idTipoRelacion,DiasVencimiento, Correo)
		VALUES(@IdEntidad, @IdEmpresa, @UsuarioRegistro,DATEADD(HOUR, 3, GETDATE()),@FlagBorrador, 1,@IdTipoRelacion,@DiasVencimiento, @Correo)

		SET @IdProveedor = (SELECT CAST(SCOPE_IDENTITY() AS INT));
