CREATE TABLE [ERP].[ComprobanteDetalle] (
    ...
    [Fecha]                     DATETIME        NULL,
    CONSTRAINT [PK__Comproba__3214EC2716AE20BB] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [FK__Comproban__IdCom__69279377] FOREIGN KEY ([IdComprobante]) REFERENCES [ERP].[Comprobante] ([ID]),
    CONSTRAINT [FK__Comproban__IdPro__6A1BB7B0] FOREIGN KEY ([IdProducto]) REFERENCES [ERP].[Producto] ([ID])
);
